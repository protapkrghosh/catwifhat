...
const TryAnotherCat = () => {
  return (
    <div className='mt-[150px] mb-20 lg:mb-0'>
      <Container>
        ...
        <div>
          ...
          <p className='text-[#DF355F] text-center text-[38px] md:text-[50px] lg:text-[49px] xl:text-[67px] 2xl:text-[75px] lg:leading-[96px] tracking-[2.4px] mb-14 lg:mb-[40px] xl:mb-[60px]'>TRY ANOTHER CAT WITH ANOTHER HAT</p>
        </div>
